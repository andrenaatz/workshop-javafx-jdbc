...
public class MainViewController implements Initializable {
	...
	private synchronized <T> void loadView(String absoluteName, Consumer<T> inicializingAction) {
		...
		mainVBox.getChildren().addAll(newVBox.getChildren());//vai buscar filhos de about - absoluteName
		
		T controller = loader.getController(); // necessario implementar estas duas linhas para funcionar o generic
